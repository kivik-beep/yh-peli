...
TFC(FindLastAllElementsDetachedContinuation, FindLastAllElementsDetachedContinuation) \
TFJ(TypedArrayPrototypeFindLast, kDontAdaptArgumentsSentinel) \
TFC(FindLastIndexAllElementsDetachedContinuation, FindLastIndexAllElementsDetachedContinuation) \
